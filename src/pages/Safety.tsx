...
const faqs = [
  ...
  {
    question: "Могу ли я использовать Quiet Bay, если я уже хожу к терапевту?",
    answer: "Да! Многие наши пользователи находят Quiet Bay полезным как дополнение к регулярным сеансам терапии. Он может обеспечить поддержку между приёмами и помочь вам обработать мысли перед обсуждением их с терапевтом.",
  },
  {
