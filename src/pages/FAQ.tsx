...
const paymentFaqs = [
  {
    ...
    answer: "Бесплатный план включает ограниченное время общения в день, базовые разговоры для эмоциональной поддержки, доступ к дыхательным упражнениям и кризисные ресурсы. Это отличный способ попробовать Quiet Bay и понять, подходит ли он вам."
  },
  {
  ...
  },
  {
    ...
    answer: "Мы принимаем все основные кредитные карты (Visa, MasterCard, American Express) и дебетовые карты через наш защищённый платёжный процессор ЮKassa."
  },
];
